...
- Show the results (e.g., into `MY_OUTPUT/`):
  - `detection_*` – images with detected region visualized
- Compare your crops with the ground-truth crops in `OUTPUT_CHECK/`.
...
3. Validate your results by comparing them with the crops in `OUTPUT_CHECK/`.
